...
export default function Navbar(): JSX.Element {
    ...
    const animations = {
      ...
      const JSIcon = () => {
        return (
            <div className="w-[32px] h-[40px] lg:w-[42px] lg:h-[50px] flex items-center justify-center bg-accent text-white font-bold text-2xl lg:text-3xl rounded-lg animate-bounce">
            JS
          </div>
        );
      };
  ...
  href="../assets/jassem-resume.pdf" 
  download="jassem-souey-resume.pdf"
>
  Resume
</a>
                    </div>
