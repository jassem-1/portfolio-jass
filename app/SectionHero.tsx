            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    <motion.p
                        ...
                        aria-label="Welcome to Jassem's Portfolio"
                    >
                        Welcome to Jassem&apos;s Portfolio
                    </motion.p>
                    <motion.h2
                    ...
                    <motion.p
                        ...
                        aria-label="I'm jassem Souey. A passionate  fullstack developer
specialized in building scalable, user-centric applications. Passionate
about continuous learning and leveraging new technologies to drive
innovative solutions.."
                    >
                        I&apos;m jassem Souey. A passionate  fullstack developer
